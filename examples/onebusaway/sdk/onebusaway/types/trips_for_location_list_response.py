...
class TripsForLocationListResponseDataListSchedule(BaseModel):
    ...
    stop_times: List[TripsForLocationListResponseDataListScheduleStopTime] = Field(alias="stopTimes")
...
class TripsForLocationListResponseDataListStatus(BaseModel):
    ...
    last_known_location: Optional[TripsForLocationListResponseDataListStatusLastKnownLocation] = Field(default=None, alias="lastKnownLocation")
...
class TripsForLocationListResponseData(BaseModel):
    ...
    out_of_range: Optional[bool] = Field(default=None, alias="outOfRange")
