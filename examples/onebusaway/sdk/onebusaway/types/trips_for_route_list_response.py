...
class TripsForRouteListResponseDataListSchedule(BaseModel):
    ...
    stop_times: List[TripsForRouteListResponseDataListScheduleStopTime] = Field(alias="stopTimes")
...
class TripsForRouteListResponseDataListStatus(BaseModel):
    ...
    last_known_location: Optional[TripsForRouteListResponseDataListStatusLastKnownLocation] = Field(default=None, alias="lastKnownLocation")
